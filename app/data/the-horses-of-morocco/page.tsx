...
export default function HorsesOfMoroccoPage() {
  ...
  return (
    <div className="pt-16" style={{ background: '#ffffff' }}>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 10, color: '#a3a3a3', marginTop: 16, fontFamily: "'IBM Plex Mono', monospace" }}>Sources: SOREC, WAHO, OMCB, Mad Barn. © Dancing with Lions</p>
      </section>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 10, color: '#a3a3a3', marginTop: 16, fontFamily: "'IBM Plex Mono', monospace" }}>Sources: Wikipedia, SBHA, Oklahoma State, Woman O'War. © Dancing with Lions</p>
      </section>
      ...
      <section style={{ padding: '40px 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 10, color: '#a3a3a3', marginTop: 16, fontFamily: "'IBM Plex Mono', monospace" }}>© Dancing with Lions · dancingwithlions.com</p>
      </section>
    </div>
  )
}
