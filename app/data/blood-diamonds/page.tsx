...
export default function BloodDiamonds() {
  ...
  return (
    <div className="bg-white text-[#262626] pt-16">
      ...
      <section className="border-t border-[#e5e5e5] mt-0"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <p className="text-[14px] text-[#525252] leading-relaxed max-w-[560px] mb-10">The DRC bar is on a logarithmic scale because if it were linear, you wouldn\u2019t see Sierra Leone. You wouldn\u2019t see Angola. Six million dead is a number that breaks the chart. It\u2019s also a number that breaks the Kimberley Process claim that conflict diamonds are \u201cless than 1%.\u201d They redefined the problem until the statistic improved.</p>
        <DeathTollChart />
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-10">
          {[
            { to: "A Diamond Is Not Forever", link: "/data/a-diamond-is-not-forever", insight: "De Beers built the demand that made diamonds worth killing for. The economic collapse and the human cost \u2014 two sides of the same stone." },
            { to: "The Blood Gold", link: "/data/the-blood-gold", insight: "Gold replaced diamonds as the preferred conflict mineral. Wagner/Africa Corps in CAR \u2014 same territory, same extraction, different mineral." },
            { to: "The Shadow State", link: "/data/the-shadow-state", insight: "Al-Shabaab\u2019s $200M/year revenue comes from the same shadow economy model diamond-funded armed groups pioneered." },
            { to: "The Lake of Fire", link: "/data/the-lake-of-fire", insight: "The armed group business model \u2014 control territory, extract resources, build parallel governance \u2014 was perfected in the diamond wars." },
          ].map((c, i) => (
            <div key={i} className="border-l-[3px] pl-6 md:pl-8" style={{ borderColor: "#DC2626" }}>
              <Link href={c.link} className="text-[10px] text-[#DC2626] uppercase tracking-[0.1em] underline hover:no-underline font-semibold">{c.to}</Link>
