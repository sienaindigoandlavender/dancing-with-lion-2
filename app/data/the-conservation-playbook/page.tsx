...
export default function TheConservationPlaybook() {
  ...
  return (
    <div className="bg-white text-[#262626] pt-16">
      ...
      <section className="border-t border-[#e5e5e5] bg-[#fafafa]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <p className="text-[14px] text-[#525252] leading-relaxed max-w-[560px] mb-10">The debate over &ldquo;what works&rdquo; in African conservation fails because it assumes a single answer. There are five distinct architectures, each optimised for different conditions. Namibia&rsquo;s conservancy model requires democratic tradition and tourism markets. Rwanda&rsquo;s permit model requires charismatic megafauna and political stability. <Link href="/data/the-gorongosa-resurrection" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">Gorongosa</Link>&rsquo;s philanthropic model requires a Greg Carr. The question is not which is best. The question is which fits the landscape, the people, and the political economy.</p>
        <ModelTaxonomy />
      </div></section>
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-10">
          {[
            { to: 'The Conservation Deficit', link: '/data/the-conservation-deficit', insight: 'The systemic view. $29.3B in wildlife tourism GDP, $1.1B in conservation funding, $4B annual shortfall. Six visualizations mapping the architecture that doesn\'t exist.' },
            { to: 'The Lion Guardians', link: '/data/the-lion-guardians', insight: 'Amboseli-Tsavo, Kenya. The cultural guardian model in full detail. 42 lions killed in 2006. Zero in 2024. The warriors\' own idea. The act of naming as cultural transformation.' },
            { to: 'The Namibia Model', link: '/data/the-namibia-model', insight: 'The community conservancy architecture. 86 conservancies. 45.6% of the country. The pioneer stories, the revenue debate, and the stress test: drought + COVID + cull.' },
            { to: 'The Gorilla Dividend', link: '/data/the-gorilla-dividend', insight: 'Rwanda\'s high-value permit model. $1,500 per hour. Population 254→1,063. $200M revenue from 0.1% of land. The only great ape that is increasing.' },
            { to: 'The Lion Economics', link: '/data/the-lion-economics', insight: 'Continental lion economics. $20.5B safari market. 200,000→23,000. Dead vs alive valuations. Why the math works but the plumbing doesn\'t.' },
            { to: 'The Last Lions', link: '/data/the-last-lions', insight: 'The Barbary lion. What happens when nobody builds the architecture. 100,000 years in North Africa. Extinct by the 1960s. ~90 descendants in zoos.' },
          ].map((c, i) => (
      ...
      <section className="border-t border-[#e5e5e5] bg-[#fafafa]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16">
        ...
        <div className="mt-8 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-t border-[#e5e5e5]">
          <p className="text-[12px] text-[#737373]">Research, visualisation &amp; analysis: <strong className="text-[#0a0a0a]">Dancing with Lions</strong></p>
