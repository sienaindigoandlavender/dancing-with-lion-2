...
export default function TheGorillaDividend() {
        ...
        <div className="space-y-10">
          {[
            ...
            <div key={i} className="border-l-[3px] pl-6 md:pl-8" style={{ borderColor: "#2D5F3A" }}>
              <Link href={c.link} className="text-[10px] text-[#4A8C5C] uppercase tracking-[0.1em] underline hover:no-underline font-semibold">{c.to}</Link>
