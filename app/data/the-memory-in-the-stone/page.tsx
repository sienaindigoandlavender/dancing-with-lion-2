...
export default function MemoryInStonePage() {
    ...
    <div style={{ background: '#ffffff', color: '#0a0a0a', fontFamily: mono }}>
      ...
      <section style={{ padding: '40px 24px 120px', maxWidth: 800, margin: '0 auto' }}>
        <div style={{ borderTop: '1px solid #e5e5e5', paddingTop: 20 }}>
          ...
          <p style={{ fontSize: 10, color: '#a3a3a3', marginTop: 8 }}>© Dancing with Lions · All data compiled from institutional sources. Site coordinates approximate.</p>
        </div>
      </section>
    </div>
  )
