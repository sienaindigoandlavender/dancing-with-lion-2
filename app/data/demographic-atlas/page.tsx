          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-[12px] leading-[1.7]" style={{ color: C.text }}>
                ...
                and education. The cooperatives — <Link href="/data/argan-triangle" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">argan</Link>, textile, agriculture — fill some
