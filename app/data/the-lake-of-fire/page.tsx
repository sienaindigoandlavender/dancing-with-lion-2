...
export default function TheLakeOfFire() {
        ...
        <div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
          ...
          <div className="space-y-10">
            {[
              ...
              { to: 'The Sahel War', link: '/data/the-sahel-war', insight: 'ISSP\'s Lakurawa subgroup is expanding from Niger into Nigeria\'s Sokoto and Kebbi — meeting ISWAP from the east. The Sahel war and the Lake Chad war are merging into a single interconnected conflict zone. Previously distinct conflicts are becoming one theater. ACLED: "Previously distinct conflicts in the Sahel and coastal West Africa are merging."' },
              { to: 'The Blood Gold', link: '/data/the-blood-gold', insight: 'Wagner/Africa Corps deployed to Mali, Burkina Faso, Niger — the same countries where ISSP operates and where Lakurawa is expanding into Nigeria. The junta security model (invite Russia, expel the West) is failing across the entire region. Niger exited the MNJTF in March 2025, further weakening Lake Chad Basin coordination.' },
            ].map((c, i) => (
