...
const HUBS: Hub[] = [
  ...
  { name: 'Essaouira', type: 'Coastal <Link href="/data/medina-atlas" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">medina</Link>', wifi: '40–80 Mbps', vibe: 'Wind, art, and <Link href="/data/the-gnawa-road" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">Gnawa</Link> music. Noqta Space in the medina. Best creative energy.',
    coliving: ['Noqta Space', 'Atlantic Hostel'], cost: '$900–1,400/mo', color: C.ocean },
  { name: 'Marrakech', type: 'Imperial city', wifi: '50–100 Mbps', vibe: 'Riad rooftops and <Link href="/data/anatomy-of-a-riad" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">riad</Link> Wi-Fi. The Spot, New Work Lab, Atic. Most infrastructure.',
