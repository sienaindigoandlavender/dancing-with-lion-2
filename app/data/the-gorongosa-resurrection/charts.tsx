...
export function SpeciesRecovery() {
  ...
  return (
    <div ref={ref} className="space-y-3">
      ...
      <p className="text-[9px] text-[#a3a3a3] mt-3">Before = post-war nadir (~1994-2004). After = 2024-25 survey data. Sources: Gorongosa Restoration Project, BBVA Foundation, 60 Minutes. © Dancing with Lions</p>
    </div>
  )
}
