    ...
    <div className="pt-16" style={{ background: '#ffffff' }}>
      ...
      <div ref={notes.ref}><section className="bg-[#f5f5f5]"><div className="px-8 md:px-[8%] lg:px-[12%] py-24 md:py-40">
        ...
        <div className="space-y-10 max-w-[640px]">
          <div style={{ opacity: notes.vis ? 1 : 0, transition: 'opacity 0.6s' }}><h3 className="font-serif text-[22px] text-dwl-black">The 73.5°C Country</h3><p className="text-[15px] text-dwl-gray leading-relaxed mt-3">Africa's coldest recorded temperature belongs to Morocco: −23.9°C at Ifrane, 11 February 1935. A mountain town at 1,665m in the <Link href="/data/atlas-mountains" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">Middle Atlas</Link>, covered in snow half the year. Morocco's hottest verified temperature: 49.6°C at Marrakech, 17 July 2012. Between these two numbers: 73.5°C. A single country that spans the full thermal range of an entire continent.</p></div>
          <div style={{ opacity: notes.vis ? 1 : 0, transition: 'opacity 0.6s 0.2s' }}><h3 className="font-serif text-[22px] text-dwl-black">The Canary Current</h3><p className="text-[15px] text-dwl-gray leading-relaxed mt-3">A cold ocean current flows south along Morocco's <Link href="/data/atlantic-coast" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">Atlantic coast</Link>, creating summer fog from Essaouira to Agadir. The paradox: the sea is colder in the south than the north. Agadir — at latitude 30°N, nearly Saharan — stays cooler than Tangier in summer. This current is why Morocco's Atlantic coast feels like California, not like the desert 100km inland.</p></div>
