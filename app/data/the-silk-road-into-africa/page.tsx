      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]">
        <div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
          ...
          <div className="space-y-10">
            {[
              { to: 'The Atlantic Spine', link: '/data/the-atlantic-spine', insight: "Nigeria's $20B gas park and the Nigeria\u2013Morocco Gas Pipeline share the same geography. Two competing visions for the same molecule: one flows north to Europe via Morocco, the other flows east to Chinese industrial processing." },
              { to: 'The Blood Gold', link: '/data/the-blood-gold', insight: 'China builds infrastructure. Russia sends mercenaries. In the Sahel, AES juntas expelled Western forces and welcomed both. Mali, Burkina Faso, Niger receive Wagner fighters and Chinese loans simultaneously.' },
              { to: 'The Sahel War', link: '/data/the-sahel-war', insight: "Chinese infrastructure requires stability. The Sahel has none. Railways and power grids mean nothing if the state cannot secure the corridor. JNIM controls 50% of Mali. China's investment is a bet that the state will survive." },
            ].map((c, i) => (
