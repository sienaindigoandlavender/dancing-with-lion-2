...
export default function TheDemographicDividend() {
    ...
    <div className="bg-white text-[#262626] pt-16">
      ...
      <section className="border-t border-[#e5e5e5]"><div className="max-w-[700px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="text-[14px] text-[#262626] leading-[1.85] space-y-5" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
          ...
          <p>The harder story is what happens without the dividend. Twenty million young Africans will enter the labour force every year by 2035 — more than the rest of the world combined. If the economies that receive them cannot provide productive employment, the youth bulge becomes a youth bomb. This is not speculation. The evidence is already visible: youth-led protests in Senegal, Nigeria, Kenya, and Ethiopia. Waves of migration across the Mediterranean. Recruitment by armed groups in the <Link href="/data/the-sahel-war" style={{ textDecoration: 'underline', textUnderlineOffset: '3px' }}>Sahel</Link>. The correlation between high fertility, low income, and instability is not a coincidence — six of the seven highest-fertility countries in Africa are low-income.</p>
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-8">
          {[
            { to: 'The Infrastructure Revolution', link: '/data/the-infrastructure-revolution', insight: '$2.5 trillion in planned projects is not ambition. It is the arithmetic of doubling a population in 25 years.' },
            { to: 'Morocco\'s Port Strategy', link: '/data/moroccos-port-strategy', insight: 'Morocco entered its dividend window early and built the infrastructure to capture it. Tanger Med is what the dividend looks like when the policy works.' },
            { to: 'The Conservation Deficit', link: '/data/the-conservation-deficit', insight: 'Africa\'s population doubles but its wildlife habitat does not. The conservation funding gap widens with every birth.' },
          ].map((c, i) => (
