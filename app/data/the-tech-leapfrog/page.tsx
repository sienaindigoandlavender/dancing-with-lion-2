...
export default function TheTechLeapfrog() {
  return (
        ...
        <div className="space-y-8">
          {[
            ...
            <div key={i} className="border-l-[3px] pl-6 md:pl-8" style={{ borderColor: '#047857' }}>
              <Link href={c.link} className="text-[10px] text-[#34d399] uppercase tracking-[0.1em] underline hover:no-underline font-semibold">{c.to}</Link>
