...
export default function TheCreativeExplosion() {
  return (
    <div className="bg-white text-[#262626] pt-16">
      <section className="relative bg-[#0a0a0a] text-white overflow-hidden"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-24 md:py-36 relative z-10">
        ...
        <p className="text-[15px] text-white/50 leading-relaxed max-w-[540px] mb-10">Afrobeats went from 2 billion to 24 billion Spotify streams in seven years. Nollywood produces 2,500 films annually, more than Hollywood. The fashion industry is worth $31 billion. Nigeria&rsquo;s entertainment sector is projected to reach $13.6 billion by 2028. Africa&rsquo;s <Link href="/data/the-creative-economy" className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">creative economy</Link> is the continent&rsquo;s most powerful soft-power export — and it is only beginning.</p>
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-6">
          {[{to:'The Demographic Dividend',link:'/data/the-demographic-dividend',insight:'Median age 19.3. The youngest continent is the most creative. Gen Z Africans are digital natives producing content the world consumes.'},{to:'The Tech Leapfrog',link:'/data/the-tech-leapfrog',insight:'Streaming platforms are the distribution layer. Flutterwave processes royalty payments. The tech stack and creative economy are fused.'}].map((c,i)=>(
            <div key={i} className="border-l-[3px] pl-6 md:pl-8" style={{borderColor:'#7C3AED'}}>
              <Link href={c.link} className="text-[10px] text-[#c084fc] uppercase tracking-[0.1em] underline hover:no-underline font-semibold">{c.to}</Link>
      ...
      <section className="border-t border-[#e5e5e5] bg-[#fafafa]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16">
        ...
        <div className="mt-8 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-t border-[#e5e5e5]">
          <p className="text-[12px] text-[#737373]">Research &amp; analysis: <strong className="text-[#0a0a0a]">Dancing with Lions</strong></p>
