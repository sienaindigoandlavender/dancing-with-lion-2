      ...
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        <FadeIn>
          ...
          <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid #f0f0f0', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: 11, color: '#bbb' }}>© Dancing with Lions · dancingwithlions.com</span>
...
/* ─── PAGE ─── */
export default function TheVerticalMigration() {
  return (
