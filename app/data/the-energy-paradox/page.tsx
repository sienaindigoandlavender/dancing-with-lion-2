...
export default function TheEnergyParadox() {
  return (
    <div className="bg-white text-[#262626] pt-16">
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-8">
          {[
            { to: 'The Infrastructure Revolution', link: '/data/the-infrastructure-revolution', insight: 'GERD and Hyphen appear in both stories — energy is infrastructure, and infrastructure is energy. The $2.5T pipeline of African megaprojects is inseparable from the energy equation.' },
