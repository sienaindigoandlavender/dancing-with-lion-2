...
export default function TheBloodGold() {
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]">
        <div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
          ...
          <div className="space-y-10">
            {[
              { to: 'The Sahel War', link: '/data/the-sahel-war', insight: 'Wagner/Africa Corps operates in the same Sahel countries where JNIM and ISSP are expanding. In Mali, junta + Russian forces killed more civilians (76% of fatalities) than jihadists in 2024. The counterterrorism operation became the recruitment operation.' },
              ...
              { to: 'The Lake of Fire', link: '/data/the-lake-of-fire', insight: 'Niger — where Wagner/Africa Corps deployed in 2024 — exited the MNJTF in March 2025, weakening Lake Chad Basin coordination against Boko Haram and ISWAP. The junta security model is failing across the entire region.' },
              { to: 'The Shadow State', link: '/data/the-shadow-state', insight: 'Russia relocated military equipment from Syria to Libya after Assad fell (Dec 2024). Libya provides logistical and financial support to Sahel groups. Wagner gold laundering routes (mine → Syria → UAE → Russia) run parallel to weapons pipelines flowing the other direction.' },
            ].map((c, i) => (
