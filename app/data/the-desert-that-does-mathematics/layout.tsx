...
export const metadata: Metadata = {
  ...
  keywords: [
    'fairy circles', 'Namibia', 'Namib Desert', 'NamibRand', 'Stipagrostis',
    'Turing pattern', 'Alan Turing', 'morphogenesis', 'reaction-diffusion',
    'self-organization', 'vegetation patterns', 'hexagonal', 'termites',
    'Psammotermes', 'sand termites', 'Getzin', 'Jürgens', 'Bonachela',
    'water stress', 'ecohydrology', 'Himba', 'Pilbara', 'Australia',
    'swarm intelligence', 'ecosystem engineering', 'arid grasslands',
  ],
}
