...
export default function ThePoachingEconomics() {
  return (
    <div className="bg-white text-[#262626] pt-16">
      ...
      <section className="border-t border-[#e5e5e5] bg-[#0a0a0a]"><div className="max-w-[1000px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-8">
          {[
            { to: 'The Rhino Underground', link: '/data/the-rhino-underground', insight: '2,000 rhinos. One failed auction. The largest wildlife translocation in history. And the breeder who was just arrested for trafficking.' },
            { to: 'The Conservation Playbook', link: '/data/the-conservation-playbook', insight: 'The programmes that actually reduce poaching scored against those that don\'t. Five mechanisms. Ten models. The scorecard.' },
            { to: 'The Conservation Deficit', link: '/data/the-conservation-deficit', insight: '$29.3B in tourism GDP. $23B in illegal trade. $1.1B in conservation funding. The deficit is architectural.' },
            { to: 'The Lion Guardians', link: '/data/the-lion-guardians', insight: '$100/month turned warriors from killers into protectors. The economic intervention that produced 99% reduction in lion killing.' },
          ].map((c, i) => (
