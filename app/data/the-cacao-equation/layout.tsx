...
export default function Layout({ children }: { children: React.ReactNode }) {
  const articleSchema = {
    ...
    '@type': 'Article',
    headline: 'The Cacao Equation — From Sacred Drink to $169 Billion Industry | Dancing with Lions',
    description: 'West Africa grows 70% of the world\\',
    url: 'https://dancingwiththelions.com/data/the-cacao-equation',
